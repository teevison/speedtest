...
speed() {
    ...
    speed_test '1430' 'Tirana, Albania'
    speed_test '11123' 'London, UK'
    speed_test '2872' 'Bologna, Italy'
    speed_test '2872' 'Athens, Greece'
    speed_test '1249' 'Lisbon, Portugal'
    speed_test '20507' 'Berlin, Germany'
    speed_test '5235' 'Stockholm, Sweden'
    speed_test '14164' 'Helsinki, Finland'
    speed_test '11787' 'Oslo, Norway'
    speed_test '3188' 'Zurich, Switzerland'
    speed_test '1363' 'Brno, Czech'
    speed_test '10269' 'Los Angeles, CA'
    speed_test '6355' 'Natal, Brazil'
